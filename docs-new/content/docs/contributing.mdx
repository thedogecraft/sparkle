---
title: Contributing
description: Ways to contribute to the Sparkle project.
---
...
See the full guide: [Contributing New Apps](/docs/apps#contributing-new-apps)

## Creating Tweaks

Want to add a new tweak? Tweaks use PowerShell scripts and a `meta.json` configuration file.

See the full guide: [Creating Tweaks](/docs/creating-tweaks)
...
# Start development mode (Admin Recommended. Some things only work with admin)
pnpm dev
```
