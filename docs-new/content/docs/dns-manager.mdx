---
title: DNS Manager
description: DNS provider selection and custom DNS configuration features.
---
...
<Callout>
Users can select a provider to apply DNS changes to the active Wifi and Ethernet adapters.
</Callout>
