...
/**
 * Render a portal-based dropdown that positions its option panel relative to the trigger and closes on outside interaction or window resize/scroll.
 *
 * @param {Object} props
 * @param {string[]} props.options - Array of option labels to display.
 * @param {string} props.value - Currently selected option label.
 * @param {(option: string) => void} props.onChange - Callback invoked with the selected option when an option is clicked.
 * @returns {JSX.Element} The dropdown component element.
 */
