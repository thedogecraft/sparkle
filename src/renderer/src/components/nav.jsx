...
/**
 * Renders the application's left sidebar navigation with collapsible tabs, branding, external links, and a restart confirmation flow.
 *
 * Highlights the active tab from the current route, supports a collapsed state that hides labels and adjusts layout, shows a "New" badge for the Utilities tab, and displays a restart button when a restart is required. Confirming restart in the modal sends an IPC request on the "restart" channel.
 *
