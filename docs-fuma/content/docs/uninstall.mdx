...
{/* <img src="../images/sparklerestore.png" alt="Sparkle Screenshot showing the user how to restore" title="Sparkle Screenshot showing the user how to restore" style={{ width: '850px' }} /> */}
